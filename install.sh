...
echo ""
echo -e "  ${BOLD}Descripción de uso:${RESET}"
echo ""
echo -e "  ${BOLD}1. Generar documentación (una vez)${RESET}"
dim "    En Cursor/Antigravity: @discover.md"
echo ""
echo -e "  ${BOLD}2. Implementar un flujo${RESET}"
dim "    En el chat: @implement.md FLOW-003"
echo ""
echo -e "  ${BOLD}3. Actualizar estado en el YAML${RESET}"
dim "    En el chat: @update.md — FLOW-003 implementado, tests en..."
echo ""
