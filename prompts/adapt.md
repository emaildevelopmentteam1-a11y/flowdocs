...
2. **Estructura:** El archivo de pistas es markdown; no generes documentación de flujos. El siguiente paso es @discover.md, que detectará automáticamente si usar modo modular (`project.yaml`) o legacy (`flows.yaml`).
3. **Para el viewer:** Adapt no genera documentación de flujos. Tras ejecutar @discover.md, el usuario abre o recarga el viewer para ver la documentación.
